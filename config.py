...
class TeamMember(TypedDict):
    ...
    desc: str
    url: str
    inquiry_tag: str   # Pre-selects this chip when the card is clicked
...
SITE_CONFIG: SiteConfig = {
    ...
    "team": [
        {"role": "Creative Writers",     "desc": "Story architects who adapt fast.",                      "url": "#", "inquiry_tag": "Brand Assets"},
        {"role": "Visual Editors",       "desc": "Photo and video alchemists.",                           "url": "#", "inquiry_tag": "Video Production"},
        {"role": "Automation Engineers", "desc": "Python engineers building custom scrapers and bots.",   "url": "#", "inquiry_tag": "Web Design"},
        {"role": "Web Architects",       "desc": "Front-end and full-stack architecture.",                "url": "#", "inquiry_tag": "UI/UX"},
    ],
